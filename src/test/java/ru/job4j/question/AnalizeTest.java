...
class AnalizeTest {
    ...
    /**
     * Когда последовательность не изменена
     */
    @Test
    void whenNotChanged() {
    ...
    /**
     * Когда изменено имя User u1, удален User u3 и добавлен User u4
     */
    @Test
    void whenAllChanged() {
        User u1 = new User(1, "A");
    ...
    /**
     * Когда удален User u3 добавлен User u4
     */
    @Test
    void whenOneAddedEndOneDeleted() {
        User u1 = new User(1, "A");
        User u2 = new User(2, "B");
        User u3 = new User(3, "C");
        Set previous = Set.of(u1, u2, u3);
        Set current = Set.of(u1, u2, new User(4, "D"));
