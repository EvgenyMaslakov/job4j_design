...
class ArgsNameTest {
    ...
    void whenStringDoesNotContainKeyThenExceptionThrown3() {
        assertThatThrownBy(() -> ArgsName.of(new String[]{"-Xmx=512", "-==password"}))
                .isInstanceOf(IllegalArgumentException.class)
                .hasMessageMatching("^.+")
    ...
    @Test
    void whenStringDoesNotContainKeyThenExceptionThrown4() {
        assertThatThrownBy(() -> ArgsName.of(new String[]{"-Xmx=512", "-=значение"}))
                .isInstanceOf(IllegalArgumentException.class)
                .hasMessageMatching("^.+")
                .hasMessageContaining("Error: This argument '-=значение' does not contain a key");
    }
    ...
    void whenStringDoesNotContainValueThenExceptionThrown3() {
        assertThatThrownBy(() -> ArgsName.of(new String[]{"-Xmx=512", "-ключ="}))
                .isInstanceOf(IllegalArgumentException.class)
                .hasMessageMatching("^.+")
                .hasMessageContaining("Error: This argument '-ключ=' does not contain a value");
    }
    ...
    void whenThereNoEqualSignThenExceptionThrown2() {
        assertThatThrownBy(() -> ArgsName.of(new String[]{"-Xmx=512", "-ключ:значение"}))
                .isInstanceOf(IllegalArgumentException.class)
                .hasMessageMatching("^.+")
                .hasMessageContaining("Error: This argument '-ключ:значение' does not contain an equal sign");
    }
    ...
    void whenNoHyphenPrefixThenExceptionThrown2() {
        assertThatThrownBy(() -> ArgsName.of(new String[]{"-Xm^.+x=51^.+2", "request=?m^.+sg=Ex^.+it="}))
                .isInstanceOf(IllegalArgumentException.class)
                .hasMessageMatching("^.+")
                .hasMessageContaining("Error: This argument 'request=?m^.+sg=Ex^.+it=' does not start with a '-' character");
    }

    @Test
    void whenNoHyphenPrefixThenExceptionThrown3() {
        assertThatThrownBy(() -> ArgsName.of(new String[]{"-Xmx=512", "ключ=значение"}))
                .isInstanceOf(IllegalArgumentException.class)
                .hasMessageMatching("^.+")
                .hasMessageContaining("Error: This argument 'ключ=значение' does not start with a '-' character");
    }
}